...
type FancyWorkspaceSelectorProps = {
  currentProject: t_project
  projects: t_project[]
  onProjectChange: (project: t_project) => void
  onCreateProject: (project: Omit<t_project, "id" | "createdAt" | "updatedAt">) => Promise<any>
...
export function FancyWorkspaceSelector({
  ...
  const [projectToEdit, setProjectToEdit] = useState<t_project | null>(null)
  const [projectToDelete, setProjectToDelete] = useState<t_project | null>(null)
  ...
  function handleEditProject(project: t_project, event: React.MouseEvent) {
    event.stopPropagation()
    setProjectToEdit(project)
    setShowEditDialog(true)
  }

  function handleDeleteProject(project: t_project, event: React.MouseEvent) {
    event.stopPropagation()
