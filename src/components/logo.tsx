...
function getPathVariants(): Variants {
	return {
...
function getCircleVariants(): Variants {
	return {
...
function getStreamVariants(): Variants {
	return {
...
function LogoIcon() {
	...
	const circleVariants = getCircleVariants();
	const streamVariants = getStreamVariants();
