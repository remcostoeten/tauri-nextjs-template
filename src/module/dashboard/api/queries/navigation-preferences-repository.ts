...
import { navigationPreferences, type t_navigation_preference, type t_new_navigation_preference } from "@/module/dashboard/api/schema/navigation-preferences-schema"
