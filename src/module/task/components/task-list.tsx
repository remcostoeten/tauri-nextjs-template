...
import { TTaskPriority } from '../types/task-types';
...
type TaskListProps = {
    ...
    initialData?: Awaited<ReturnType<typeof import('../api/actions/task-actions').getTasks>>;
};

export function TaskList({ projectId, defaultSection, initialData }: TaskListProps) {
    const {
        tasks,
        sections,
        labels,
